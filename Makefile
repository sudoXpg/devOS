FILES = ./build/kernel.asm.o ./build/kernel.o ./build/idt/idt.asm.o ./build/idt/idt.o ./build/memory/memory.o ./build/string/string.o ./build/display/display.o ./build/io/io.asm.o ./build/memory/heap/heap.o ./build/memory/heap/kheap.o ./build/memory/paging/paging.o ./build/memory/paging/paging.asm.o ./build/disk/disk.o
INCLUDES = -I./src
...
./build/display/display.o: ./src/display/display.c
	i686-elf-gcc $(INCLUDES) $(FLAGS) -std=gnu99 -c ./src/display/display.c -o ./build/display/display.o
